...
func TestClassifyToolOrConversation_ExplicitTier1(t *testing.T) {
	tests := []struct {
		...
		{"create-email-welcome", "create-email-welcome", KindTool},
		{"create email welcome for grant", "create-email-welcome", KindTool},
		{"write-email-welcome", "create-email-welcome", KindTool},
		...
		{"read-backend", "read-backend", KindTool},
		{"read backend", "read-backend", KindTool},
